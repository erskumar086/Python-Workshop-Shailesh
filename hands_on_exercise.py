...
if(picked_fruit== "orange"):
    print("colour of fruit is orange", picked_fruit)
elif(picked_fruit== "strawberry"):
    print("colour of fruit is pink",picked_fruit)
elif (picked_fruit== "banana"):
    print("colour of fruit is yellow",picked_fruit)
